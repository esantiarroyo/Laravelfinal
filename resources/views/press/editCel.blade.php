...
<body class="bg-primary">
    ...
    <div class="bg-primary-subtle mt-3 mb-3 pt-3 pb-3 d-flex justify-content-center">
        ...
        <div><img src="/img/imgCelador.jpg" width="50%" class="img-thumbnail" alt="not fount img"></div>

        <div>
            <form action="{{ route('press.updateCel', $pres) }}" method="POST">
                @csrf @method('PATCH')
                ...
                <br><div class="d-flex justify-content-around">
                    ...
                    <a href="{{ route('press.indexCel') }}">Regresar</a>
                </div>
            </form><br>
