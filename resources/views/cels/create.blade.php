...
<head>
    ...
    <title>Crear Celador</title>
</head>

<body class="bg-primary">

    <x-layouts.app title="Crear nuevo Celador" meta-description="Formulario para crear un nuevo Celador">
    </x-layouts.app>

    <div class="h1 text-primary p-5 bg-white">
        Crear un Nuevo Celador
    </div>
